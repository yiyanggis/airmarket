...
$query = "select station, \"city or to\", \"lat.\", \"long.\",type from public.airport_point where ST_Intersects(ST_Buffer(ST_SetSRID(ST_POINT(".$lng.",".$lat."),4326),".$radius."),airport_point.geom);";
